      ...
      <main className=" bg-black px-10 md:px-20 lg:px-40">
        <section>
          ...
          <div className="text-center p-10 py-10">
            <h2 className="text-5xl py-2 text-teal-500 font-medium dark:text-teal-400 md:text-6xl font-MontserratAlternates">
              It's Soumyadeep
            </h2>
            <h3 className="text-2xl py-2 text-white md:text-3xl font-Aboreto font-semibold">
              Blockchain Learner - Full stack Developer
            </h3>

            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-300 dark:text-gray-200 ">
              <a
